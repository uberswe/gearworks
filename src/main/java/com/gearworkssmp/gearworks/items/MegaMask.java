...
public class MegaMask  extends TrinketItem implements TrinketRenderer {
	public MegaMask(Settings settings) {
		super(settings);
	}
	...
	public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
		tooltip.add(Text.translatable("item.gearworks.mega_mask.tooltip"));
