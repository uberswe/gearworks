...
public class BlueRabbitVisorHat extends TrinketItem implements TrinketRenderer {
	public BlueRabbitVisorHat(Settings settings) {
		super(settings);
	}
	...
	public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
		tooltip.add(Text.translatable("item.gearworks.blue_rabbit_visor_hat.tooltip"));
