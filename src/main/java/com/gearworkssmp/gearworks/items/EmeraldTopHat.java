...
public class EmeraldTopHat extends TrinketItem implements TrinketRenderer {
	public EmeraldTopHat(Settings settings) {
		super(settings);
	}
	...
	public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
		tooltip.add(Text.translatable("item.gearworks.emerald_top_hat.tooltip"));
