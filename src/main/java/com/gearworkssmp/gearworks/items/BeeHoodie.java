...
public class BeeHoodie extends TrinketItem implements TrinketRenderer {
	public BeeHoodie(Settings settings) {
		super(settings);
	}
	...
	public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
		tooltip.add(Text.translatable("item.gearworks.bee_hoodie.tooltip"));
