...
public class SteampunkSantaHat extends TrinketItem implements TrinketRenderer {
	public SteampunkSantaHat(Settings settings) {
		super(settings);
	}
	...
	public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
		tooltip.add(Text.translatable("item.gearworks.steampunk_santa_hat.tooltip"));
